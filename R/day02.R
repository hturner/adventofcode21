...
#' final depth?*
#'
#' @param direction vector of directions: "forward", "up" or "down"
#' @param amount vector of amounts to go in given direction
...
example_data_02 <- function(example = 1) {
  l <- list(
    a = data.frame(direction = c("forward", "down", "forward",
                                 "up", "down", "forward"),
